                        ...
                        MainTreeEvent = new TreeEvent
                        {
                            ...
                            FailingEvent = new TreeEvent
                            {
                                ...
                                ClassesProbabilitySpecification =
                                {
                                    ...
                                    new ExpertClassEstimation{Expert = roy, WaterLevel = 2.3, AverageEstimation = ProbabilityClass.None, MinEstimation = ProbabilityClass.None, MaxEstimation = ProbabilityClass.None},
                                    new ExpertClassEstimation{Expert = roy, WaterLevel = 2.6, AverageEstimation = ProbabilityClass.None, MinEstimation = ProbabilityClass.None, MaxEstimation = ProbabilityClass.None},
                                    new ExpertClassEstimation{Expert = roy, WaterLevel = 2.9, AverageEstimation = ProbabilityClass.None, MinEstimation = ProbabilityClass.None, MaxEstimation = ProbabilityClass.None},
                                    new ExpertClassEstimation{Expert = roy, WaterLevel = 3.2, AverageEstimation = ProbabilityClass.None, MinEstimation = ProbabilityClass.None, MaxEstimation = ProbabilityClass.None},
                                    new ExpertClassEstimation{Expert = roy, WaterLevel = 3.5, AverageEstimation = ProbabilityClass.None, MinEstimation = ProbabilityClass.None, MaxEstimation = ProbabilityClass.None},
                                    new ExpertClassEstimation{Expert = roy, WaterLevel = 3.8, AverageEstimation = ProbabilityClass.None, MinEstimation = ProbabilityClass.None, MaxEstimation = ProbabilityClass.None},
                                    new ExpertClassEstimation{Expert = andries, WaterLevel = 2.3, AverageEstimation = ProbabilityClass.Seven, MinEstimation = ProbabilityClass.Seven, MaxEstimation = ProbabilityClass.Seven},
