...
{
    public class ItemsCollectionViewModelBase : ViewModelBase, ITreeNodeCollectionViewModel
    {
        private bool isExpanded = true;

        protected ItemsCollectionViewModelBase(ViewModelFactory factory) : base(factory)
        {
