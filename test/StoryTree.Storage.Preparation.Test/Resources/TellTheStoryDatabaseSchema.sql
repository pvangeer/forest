...
/*  Created On : 20-nov-2018 13:38:37 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'Order' INTEGER NOT NULL,
	'Comment' TEXT,
	'HydraulicConditionElementId' INTEGER NOT NULL,
	...
	CONSTRAINT 'FK_ExpertClassEstimationEntity_HydraulicConditionElementEntity' FOREIGN KEY ('HydraulicConditionElementId') REFERENCES 'HydraulicConditionElementEntity' ('HydraulicConditionElementId') ON DELETE Cascade ON UPDATE Cascade,
...
CREATE INDEX 'IXFK_ExpertClassEstimationEntity_HydraulicConditionElementEntity'
 ON 'ExpertClassEstimationEntity' ('HydraulicConditionElementId' ASC)
;
